                                ...
                                <table class="style8">
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            <asp:DropDownList ID="drpbankname" runat="server">
                                    ...
                                    <tr>
                                        <td>
                                            16 Digit Card&nbsp; No :</td>
                                        <td>
                                            <asp:TextBox ID="txtcardno" runat="server" MaxLength="16" Width="171px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            CVV No :</td>
                                        <td style="text-align: left">
                                            <asp:TextBox ID="txtccv" runat="server" MaxLength="3" Width="68px"></asp:TextBox>
                                            &nbsp;3 Digit Only</td>
                                    </tr>
                                    <tr>
                                        <td>
